...
/* Users/nihalsaxena/Documents/svelte-ui/packages/Button.svelte generated by Svelte v3.20.1 */
...
/* Users/nihalsaxena/Documents/svelte-ui/packages/Table.svelte generated by Svelte v3.20.1 */
...
const css$1 = {
	...
	map: "{\"version\":3,\"file\":\"Table.svelte\",\"sources\":[\"Table.svelte\"],\"sourcesContent\":[\"<script>\\n  export let rows = [];\\n  export let columns = [];\\n  const sortObject = o =>\\n    Object.keys(o)\\n      .sort()\\n      .reduce((r, k) => ((r[k] = o[k]), r), {});\\n  const sortedRows = rows.map(r => sortObject(r));\\n</script>\\n\\n<style>\\n  table {\\n    font-family: arial, sans-serif;\\n    border-collapse: collapse;\\n    width: 100%;\\n  }\\n\\n  td,\\n  th {\\n    border: 1px solid #dddddd;\\n    text-align: left;\\n    padding: 8px;\\n  }\\n</style>\\n\\n<main>\\n  <table>\\n\\n    <tr>\\n      {#each columns as column}\\n        <th>{column.title}</th>\\n      {/each}\\n    </tr>\\n    {#each rows as row}\\n      <tr>\\n        {#each Object.keys(row) as rowKey}\\n          <td>{row[rowKey]}</td>\\n        {/each}\\n      </tr>\\n    {/each}\\n\\n  </table>\\n</main>\\n\"],\"names\":[],\"mappings\":\"AAWE,KAAK,eAAC,CAAC,AACL,WAAW,CAAE,KAAK,CAAC,CAAC,UAAU,CAC9B,eAAe,CAAE,QAAQ,CACzB,KAAK,CAAE,IAAI,AACb,CAAC,AAED,iBAAE,CACF,EAAE,eAAC,CAAC,AACF,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,AACd,CAAC\"}"
};
...
const Table = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main><table class="${"svelte-1aced0c"}"><tr>${each(columns, column => `<th class="${"svelte-1aced0c"}">${escape(column.title)}</th>`)}</tr>
    ${each(rows, row => `<tr>${each(Object.keys(row), rowKey => `<td class="${"svelte-1aced0c"}">${escape(row[rowKey])}</td>`)}
      </tr>`)}</table></main>`;
});

/* Users/nihalsaxena/Documents/svelte-ui/packages/Column.svelte generated by Svelte v3.20.1 */
...
/* Users/nihalsaxena/Documents/svelte-ui/packages/Row.svelte generated by Svelte v3.20.1 */
...
/* Users/nihalsaxena/Documents/svelte-ui/packages/Menu.svelte generated by Svelte v3.20.1 */
